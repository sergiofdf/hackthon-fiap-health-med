    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Agendas", x => x.Crm);
                    table.ForeignKey(
                        name: "FK_Agendas_Doctors_Crm",
                        column: x => x.Crm,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Doctors_Crm",
                        column: x => x.Crm,
                        principalTable: "Doctors",
                        principalColumn: "Crm",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_Patients_Cpf",
                        column: x => x.Cpf,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_Cpf",
                table: "Appointments",
                column: "Cpf");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_Crm",
                table: "Appointments",
                column: "Crm");
        }
